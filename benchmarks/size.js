...
const { bold, gray } = require('../colors.js')
...
async function benchmark(lib) {
   const data = await getJSON(`https://packagephobia.com/v2/api.json?p=${lib}`)
   const size = data.install.bytes
